// Ronak
//Impletement the argument fycntionality
//implement the name chane in using the connection fd 
#include "csapp.c"
...
int main(int argc, char **argv)
{
    ...
    struct stat st;
    ifd=Open("go.jpg",O_RDWR, 0);// use the name of picture argument to save output picutre name_gray
    ...
    if(fork()==0)
    {
        execl("~/eos/project/color2GreybasCnPr/displayImg","./displayImg","CLR2Grey.jpg",(char *)NULL);
    }
    int status,ret;
    ret=0;
    waitpid(-1,&status,0);
